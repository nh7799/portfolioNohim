          ...
          {data.map(
            (
              ...
              <>
                <div
                  key={i}
                  className={`${i !== activeSlide ? " opacity-30 grayscale pointer-events-none" : "shadow-2xl opacity-100 scale-95 md:scale-105"} flex-1 mx-2  card-comp z-20 shadow-xl flex flex-col gap-3 md:rounded-lg border border-gray-600 transition-all`}
